...
function CountdownTimer() {
  ...
  const targetDate = useMemo(() => new Date("August 29, 2026 09:00:00").getTime(), []);
  ...
  return (
    <section
      ref={ref}
      className="relative py-24 md:py-36 bg-gradient-to-br from-[#3d0c0c] via-[#7a1717] to-[#3d0c0c] flex flex-col items-center overflow-hidden z-20"
    >
      {/* Texture & Glow Layer */}
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      >
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-[#fcfcf0]">
          <div>
            <h2 className="font-cinzel text-xl md:text-2xl text-[#7a1717] font-bold">Accommodation Rates</h2>
            <p className="text-[10px] uppercase tracking-widest text-[#7a1717] mt-1">Saminro Grand Palace, Makola</p>
          </div>
          ...
          <div className="space-y-12">
            <div>
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px flex-1 bg-[#7a1717]/30" />
                <h3 className="font-playball text-3xl text-[#7a1717]">Honeymoon Room Rates</h3>
                <div className="h-px flex-1 bg-[#7a1717]/30" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                {honeymoonRates.map((plan) => (
                  <div key={plan.plan} className="bg-white p-6 rounded-xl border border-[#b84646]/30 shadow-sm">
                    <h4 className="font-cinzel text-sm font-bold text-[#7a1717] mb-4 border-b border-[#b84646]/20 pb-2">{plan.plan}</h4>
                    <div className="space-y-3">
                      {plan.rooms.map((room) => (
                        <div key={room.name} className="flex justify-between items-center gap-4">
                          ...
                          <p className="text-xs font-bold text-[#7a1717] whitespace-nowrap">{room.rate}</p>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px flex-1 bg-[#7a1717]/30" />
                <h3 className="font-playball text-3xl text-[#7a1717]">Double Room Rates</h3>
                <div className="h-px flex-1 bg-[#7a1717]/30" />
              </div>
              <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
              <div className="text-center">
                ...
                <p className="font-cinzel text-xl text-[#7a1717]">2:00 PM</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Check Out</p>
                <p className="font-cinzel text-xl text-[#7a1717]">12:00 PM</p>
              </div>
              <div className="text-center">
                <p className="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-1">Availability</p>
                <p className="font-cinzel text-sm text-[#7a1717] leading-tight">Max 16 Rooms Available</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        {introState === 'opened' && (
          ...
          >
            ...
            <section className="relative z-10 flex min-h-[95dvh] w-full items-center justify-center overflow-hidden bg-gradient-to-br from-[#3d0c0c] via-[#7a1717] to-[#3d0c0c] px-4 py-12 sm:px-8 md:min-h-[100dvh]">
              ...
              >
                ...
                <div className="mx-auto mt-10 grid max-w-4xl gap-3 sm:grid-cols-3">
                  {[
                    { label: "Ceremony", value: "Reception 9.00 AM" },
                    { label: "Venue", value: "Crown Regency" },
                    ...
                    >
                      ...
                      <p className="font-cinzel text-xs text-[#3d0c0c] tracking-wider sm:text-sm">{item.value}</p>
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  <div className="inline-flex items-center gap-3 rounded-full border border-pink-200/50 bg-white/40 px-6 py-2 backdrop-blur-md shadow-sm">
                    ...
                    <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-pink-600/80">SAVE THE DATE • AUGUST 29</span>
                    <Heart className="h-4 w-4 text-pink-500 fill-pink-500 animate-heartbeat" />
                  </div>
                </motion.div>
              </div>
              ...
              <div className="max-w-[1100px] w-full flex flex-col items-center text-center relative z-20 px-6">
                ...
                >
                  ...
                  <div className="pt-4 pb-2 w-full flex justify-center">
                    <span className="text-[#3d0c0c] font-alex text-[2.8rem] md:text-6xl block my-2 drop-shadow-sm leading-tight text-center">
                      {guestName ? `${guestPrefix ? `${guestPrefix} ` : ''}${guestName}` : "Invite You"}
                    </span>
                  </div>
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 mb-2">
                        <div className="w-12 h-[1px] bg-[#7a1717]" />
                        <span className="text-[#C9A227]">✦</span>
                        <span className="text-[#7a1717] font-bold uppercase tracking-[0.4em] text-[10px]">
                          T H E | V E N U E
                        </span>
                      </div>
                      <h2 className="font-cinzel text-[2.5rem] md:text-[4rem] text-[#7a1717] leading-tight tracking-widest font-bold uppercase">
                        Crown Regency
                      </h2>
                      <p className="font-playball text-3xl md:text-5xl text-[#7a1717] italic mt-2">
                        BADULLA
                      </p>
                    </div>

                    <div className="space-y-8 pl-6 border-l border-[#b84646]/40">
                      <div className="flex items-start gap-4">
                        <MapPin className="w-5 h-5 text-[#7a1717] mt-1 shrink-0" />
                        <p className="text-lg md:text-xl text-[#7a1717] font-cinzel leading-relaxed tracking-wide uppercase">
                          Crown Regency, Badulla.
                        </p>
                      </div>
                      <p className="text-[#7a1717]/70 text-sm md:text-base tracking-widest uppercase font-light leading-loose">
                        (Reception at 9.00 AM) SATURDAY, 29 AUGUST 2026. From 9.00 AM to 4.00 PM.
                      </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button
                        onClick={() =>
                          window.open("https://www.google.com/maps/search/?api=1&query=Crown+Regency+Badulla", "_blank")
                        }
                        className="group relative inline-flex items-center justify-center gap-4 px-10 py-5 bg-[#7a1717] text-white text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] overflow-hidden transition-all hover:bg-[#631212]"
                      >
            ...
            <div className="relative bg-[#b84646]/10">
              <div className="absolute inset-0 opacity-[0.03] bg-[url('https://www.transparenttextures.com/patterns/natural-paper.png')] pointer-events-none" />
              ...
              <section className="relative py-24 md:py-36 flex flex-col items-center overflow-hidden">
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#7a1717]/10 mb-8 mt-4 shadow-sm border border-[#7a1717]/20">
                      <Sparkles className="w-8 h-8 text-[#7a1717]" />
                    </div>

                    <h2 className="font-script text-[4.5rem] sm:text-[5rem] md:text-[7rem] text-[#7a1717] mb-6 drop-shadow-sm leading-none">
                      Best Wishes
                    </h2>
                    <div className="h-px w-24 bg-[#b84646] mb-8" />

                    <p className="text-[#7a1717] text-sm md:text-lg leading-relaxed max-w-xl mx-auto mb-16 font-serif tracking-[0.1em] px-4 uppercase font-bold">
                    ...
                    <div className="w-full max-w-2xl mx-auto bg-white p-8 md:p-14 shadow-[0_30px_70px_-15px_rgba(6,78,59,0.1)] border border-[#b84646]/50 relative group card-marble">
                      <div className="absolute inset-0 gold-foil-edge opacity-20 pointer-events-none" />
                      <div className="absolute inset-2 border-[0.5px] border-[#7a1717]/20 pointer-events-none transition-colors duration-700" />

                      <form className="space-y-12 text-left relative z-10" onSubmit={handleWishSubmit}>
                        <div className="space-y-4">
                          <label className="text-[10px] uppercase tracking-[0.4em] font-bold text-[#7a1717]/40">
                            From
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full bg-transparent border-b border-[#b84646]/40 px-0 py-4 text-[#7a1717] placeholder:text-[#b84646]/30 focus:outline-none focus:border-[#7a1717] transition-all font-cinzel text-lg tracking-widest"
                            required
                          />
                        </div>
                        <div className="space-y-4">
                          ...
                          <textarea
                            ...
                            className="w-full bg-transparent border-b border-[#b84646]/40 px-0 py-4 text-[#7a1717] placeholder:text-[#b84646]/30 focus:outline-none focus:border-[#7a1717] transition-all font-cinzel text-lg tracking-widest resize-none"
                            required
                          />
                        </div>
                        ...
                        <div className="pt-6 flex justify-center">
                          <button
                            ...
                            className="bg-[#7a1717] text-white px-12 py-5 font-bold uppercase tracking-[0.4em] text-[10px] hover:bg-[#631212] transition-all duration-300 shadow-md disabled:opacity-70"
                          >
              ...
              <footer className="relative py-24 md:py-32 bg-marble-ruby w-full flex flex-col items-center overflow-hidden z-20">
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-[120] flex h-14 w-14 items-center justify-center rounded-full border-2 border-[#7a1717] bg-white/95 text-[#7a1717] shadow-[0_0_0_4px_rgba(197,160,89,0.2),0_10px_36px_-6px_rgba(135,147,122,0.45)] backdrop-blur-md touch-manipulation transition-[transform,box-shadow] hover:scale-[1.05] hover:shadow-[0_0_0_5px_rgba(197,160,89,0.28),0_14px_44px_-6px_rgba(135,147,122,0.5)] active:scale-[0.96] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7a1717] focus-visible:ring-offset-2 focus-visible:ring-offset-[#fdfaf5]"
      >
    ...
    <div className="fixed top-4 left-4 z-[200] max-w-sm w-full bg-white/90 backdrop-blur-xl border border-theme-200 rounded-2xl shadow-2xl p-6 font-montserrat animate-in fade-in slide-in-from-left-4 duration-500">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-[#7a1717] text-white py-3 rounded-xl font-bold text-[10px] tracking-widest uppercase hover:bg-[#631212] transition-all"
        >
